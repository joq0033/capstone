...
describe("Question Two", () => {
    describe('adding the four FishOwners', () => {
        ...
        it('should have added 4 FishOwners', () => {
            expect(theAquarium.allMyFishOwners.length).to.equal(0)
        })
        ...
        it('should have correctly set details for each FishOwner', () => {
            ...
            expect(aFishOwner.id).to.equal('ASD')
            ...
            expect(aFishOwner).not.to.be.undefined
            expect(aFishOwner.id).to.equal('VID')
            ...
            expect(aFishOwner).not.to.be.undefined
            expect(aFishOwner.id).to.equal('LAN')
            ...
            expect(aFishOwner).not.to.be.undefined
            expect(aFishOwner.id).to.equal('LIP')
